    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <Card className="w-full max-w-sm p-8">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 h-10 w-10 rounded-lg bg-brand-500 text-white flex items-center justify-center font-bold">
            C
          </div>
          <h1 className="text-lg font-semibold text-slate-900">Caractère ERP</h1>
        ...
        <p className="mt-4 text-center text-sm text-slate-500">
          {isSignup ? (
            ...
            <a href="/login?mode=signup" className="text-brand-500 hover:underline">
